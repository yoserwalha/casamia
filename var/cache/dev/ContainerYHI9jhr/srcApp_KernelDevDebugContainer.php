...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('v8+cY9pwOX', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EK9-4VYFw9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BdhuuzBiqg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4MO5wxm-12', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('i8eZ1O1TW+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sOL1QnOxGJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('TT8CudEAAb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderd7b96 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerdfe8d = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5626d = [
        
    ];

    public function getConnection()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getConnection', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getMetadataFactory', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getExpressionBuilder', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'beginTransaction', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getCache', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getCache();
    }

    public function transactional($func)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'transactional', array('func' => $func), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'wrapInTransaction', array('func' => $func), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'commit', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->commit();
    }

    public function rollback()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'rollback', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getClassMetadata', array('className' => $className), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'createQuery', array('dql' => $dql), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'createNamedQuery', array('name' => $name), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'createQueryBuilder', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'flush', array('entity' => $entity), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'clear', array('entityName' => $entityName), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->clear($entityName);
    }

    public function close()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'close', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->close();
    }

    public function persist($entity)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'persist', array('entity' => $entity), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'remove', array('entity' => $entity), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->remove($entity);
    }

    public function refresh($entity, ?int $lockMode = null)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'refresh', array('entity' => $entity, 'lockMode' => $lockMode), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->refresh($entity, $lockMode);
    }

    public function detach($entity)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'detach', array('entity' => $entity), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'merge', array('entity' => $entity), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getRepository', array('entityName' => $entityName), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'contains', array('entity' => $entity), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getEventManager', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getConfiguration', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'isOpen', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getUnitOfWork', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getProxyFactory', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'initializeObject', array('obj' => $obj), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'getFilters', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'isFiltersStateClean', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'hasFilters', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return $this->valueHolderd7b96->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerdfe8d = $initializer;
    ...
    public function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, ?\Doctrine\Common\EventManager $eventManager = null)
    {
        ...
        if (! $this->valueHolderd7b96) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderd7b96 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderd7b96->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, '__get', ['name' => $name], $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        if (isset(self::$publicProperties5626d[$name])) {
            return $this->valueHolderd7b96->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderd7b96;
    ...
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;
    ...
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, '__isset', array('name' => $name), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;
    ...
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, '__unset', array('name' => $name), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;
    ...
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, '__clone', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        $this->valueHolderd7b96 = clone $this->valueHolderd7b96;
    }

    public function __sleep()
    {
        $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, '__sleep', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;

        return array('valueHolderd7b96');
    }
    ...
    {
        $this->initializerdfe8d = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerdfe8d;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerdfe8d && ($this->initializerdfe8d->__invoke($valueHolderd7b96, $this, 'initializeProxy', array(), $this->initializerdfe8d) || 1) && $this->valueHolderd7b96 = $valueHolderd7b96;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderd7b96;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderd7b96;
    }
}
